...
echo "import androidx.compose.foundation.layout.fillMaxHeight" >>  "$filePath"
...
echo "                        .fillMaxWidth().fillMaxHeight()" >>  "$filePath"
echo "                    ) {" >>  "$filePath"
echo "                        Text(" >>  "$filePath"
echo "                            \"This Page is For Development Time Access Only, If you reached this page accidentally, please click back arrow\"," >>  "$filePath"
