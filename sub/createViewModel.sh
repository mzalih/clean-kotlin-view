...
echo "import $package.$presenationPath.$lowername.viewmodel.LoginViewAction" >>  "$filePath"
echo "import $package.$presenationPath.$lowername.viewmodel.LoginViewEvent" >>  "$filePath"
echo "import $package.$presenationPath.$lowername.viewmodel.LoginViewState" >>  "$filePath"
...
echo "                }" >>  "$filePath"
echo "            }" >>  "$filePath"
echo "            "$filename"ViewAction.OnOpenPopUp ->{" >>  "$filePath"
echo "                _state.value = state.value.copy(isPopup = true)" >>  "$filePath"
echo "            }" >>  "$filePath"
echo "        }" >>  "$filePath"
echo "    }" >>  "$filePath"
echo "}" >>  "$filePath"
